...
Begin VB.Form Splanmain 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.PictureBox Picture8 
         ...
         Height          =   360
         Left            =   8280
         MouseIcon       =   "seqdpmain.frx":4652
         MousePointer    =   99  'Custom
         Picture         =   "seqdpmain.frx":495C
         ScaleHeight     =   360
         ScaleWidth      =   435
         TabIndex        =   22
      ...
      Begin VB.PictureBox Picture4 
         ...
         Height          =   345
         Left            =   8280
         MouseIcon       =   "seqdpmain.frx":5B0C
         MousePointer    =   99  'Custom
         Picture         =   "seqdpmain.frx":5E16
         ScaleHeight     =   345
         ScaleWidth      =   405
         TabIndex        =   19
      ...
      Begin VB.PictureBox Picture3 
         ...
         Height          =   345
         Left            =   6720
         MouseIcon       =   "seqdpmain.frx":6B00
         MousePointer    =   99  'Custom
         Picture         =   "seqdpmain.frx":6E0A
         ScaleHeight     =   345
         ScaleWidth      =   435
         TabIndex        =   18
      ...
      Begin VB.PictureBox Picture7 
         ...
         Begin VB.PictureBox Picture11 
            ...
            Height          =   445
            Left            =   4200
            MouseIcon       =   "seqdpmain.frx":6C432
            MousePointer    =   99  'Custom
            Picture         =   "seqdpmain.frx":6C73C
            ScaleHeight     =   450
            ScaleWidth      =   525
            TabIndex        =   43
         ...
         Begin VB.PictureBox Picture10 
            ...
            Height          =   370
            Left            =   4200
            MouseIcon       =   "seqdpmain.frx":6D492
            MousePointer    =   99  'Custom
            Picture         =   "seqdpmain.frx":6D79C
            ScaleHeight     =   375
            ScaleWidth      =   465
            TabIndex        =   42
         ...
         Begin VB.PictureBox Picture1 
            ...
            Height          =   345
            Left            =   2280
            MouseIcon       =   "seqdpmain.frx":6E022
            MousePointer    =   99  'Custom
            Picture         =   "seqdpmain.frx":6E32C
            ScaleHeight     =   345
            ScaleWidth      =   435
            TabIndex        =   37
         ...
         Begin VB.Label Label7 
            ...
            Index           =   2
            Left            =   2760
            MouseIcon       =   "seqdpmain.frx":6F082
            MousePointer    =   99  'Custom
            TabIndex        =   46
            ToolTipText     =   "Click to sort by Max Depth"
            Top             =   2880
            Width           =   855
         End
         Begin VB.Label Label7 
            ...
            Index           =   1
            Left            =   1680
            MouseIcon       =   "seqdpmain.frx":6F38C
            MousePointer    =   99  'Custom
            TabIndex        =   45
            ToolTipText     =   "Click to sort by plan date"
            Top             =   2880
            Width           =   735
         End
         Begin VB.Label Label7 
            ...
            Index           =   0
            Left            =   1440
            MouseIcon       =   "seqdpmain.frx":6F696
            MousePointer    =   99  'Custom
            TabIndex        =   44
            ToolTipText     =   "Click to sort by plan number"
            Top             =   2400
            Visible         =   0   'False
            Width           =   735
         End
         ...
         Begin VB.Label Label5 
            BackColor       =   &H00FF8080&
            BackStyle       =   0  'Transparent
            Caption         =   $"seqdpmain.frx":711F0
            DataField       =   $"seqdpmain.frx":7128B
            BeginProperty Font 
               Name            =   "Microsoft Sans Serif"
               Size            =   8.25
               Charset         =   0
...
Exit Sub
error_nick:
  MsgBox "Error at " & CStr(error_num_nick)
...
Private Sub Label7_Click(index As Integer)
  If index = 0 Then mnusortplanno_Click
  If index = 1 Then mnusortpdate_Click
  If index = 2 Then mnusortmaxdepth_Click
End Sub
...
Set RS5 = DB.OpenRecordset(SQL) 'nick changed to RS5
 ...
 Else
     ...
     While RS5.EOF = False
        ...
        MSFlexGrid2.Col = 4
        MSFlexGrid2.CellAlignment = 4
        If IsNull(RS5("PlanBy")) Then
        Else
          tempdate = RS5("PlanBy")
          If InStr(1, tempdate, "EGF") Then
            MSFlexGrid2.Text = Mid(tempdate, InStr(1, tempdate, "EGF") + 3, 9)
          End If
        End If
        MSFlexGrid2.Col = 2
...
'        MSFlexGrid2.Text = RS4("gasid")
        ...
        While RS4.EOF = False
           If MSFlexGrid2.Text = "" Then
              MSFlexGrid2.Text = CStr(CInt(RS4("duration"))) 'MSFlexGrid2.Text = "0"
           Else
...
Else
   ...
   While RS4.EOF = False
      ...
      While RS5.EOF = False
        ...
        MSFlexGrid2.Col = 3
           If MSFlexGrid2.Text = "" Then
              MSFlexGrid2.Text = CStr(CInt(RS5("duration"))) 'MSFlexGrid2.Text = "0"
           Else
...
Set RS = DB.OpenRecordset(SQL)
Splanmain.Caption = "VGM ProPlanner Dive Planning"
