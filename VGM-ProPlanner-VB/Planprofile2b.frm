...
Begin VB.Form Planprofile2 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox Cbogasused 
         ...
         Height          =   315
         Index           =   2
         ItemData        =   "Planprofile2.frx":6924
         Left            =   3975
         List            =   "Planprofile2.frx":6926
         Style           =   2  'Dropdown List
         TabIndex        =   69
         Top             =   4170
         Width           =   2025
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton cmdgenerate 
         ...
         Style           =   1  'Graphical
         TabIndex        =   163
         ToolTipText     =   "Modified and generate decompression result"
         Top             =   3120
         Width           =   930
      End
      ...
      Begin VB.CommandButton cmdclearall 
         ...
         Height          =   255
         Left            =   3720
         MouseIcon       =   "Planprofile2.frx":732D
         Style           =   1  'Graphical
         TabIndex        =   35
      ...
      Begin VB.CommandButton Cmdadd 
         ...
         Style           =   1  'Graphical
         TabIndex        =   3
         ToolTipText     =   "Add new level to the end of the profile"
         Top             =   2160
         Visible         =   0   'False
         Width           =   600
      End
      Begin VB.CommandButton cmdmodify 
         ...
         Style           =   1  'Graphical
         TabIndex        =   5
         ToolTipText     =   "modified the selected profile"
         Top             =   2760
         Visible         =   0   'False
         Width           =   600
      End
      Begin VB.CommandButton cmdinsert 
         ...
         Style           =   1  'Graphical
         TabIndex        =   4
         ToolTipText     =   "Insert the setting on top of the select level"
         Top             =   2460
         Visible         =   0   'False
         Width           =   585
      End
      ...
      Begin VB.Label singlelevel 
         ...
         Height          =   375
         Left            =   3240
         MouseIcon       =   "Planprofile2.frx":7637
      ...
      Begin VB.Label lbllevel 
         ...
         Height          =   255
         Left            =   3240
         MouseIcon       =   "Planprofile2.frx":7941
         MousePointer    =   99  'Custom
         TabIndex        =   161
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame7 
         ...
         Begin VB.PictureBox Picture2 
            ...
            Height          =   2895
            Left            =   1080
            Picture         =   "Planprofile2.frx":E4E8D
            ScaleHeight     =   2835
            ScaleWidth      =   3195
            TabIndex        =   21
            Top             =   960
...
If CDbl(txtdepth.Text) > CDbl(txtmaxd(CInt(Right(cbogasindex.Text, 1)))) Then
  ans = MsgBox("Depth point more then the maximum depth value allow..... " & Chr(13) & "Do you want to reset the depth point to maximum depth value ?", vbYesNo + vbCritical + vbDefaultButton2, "Comfirmation")
  Select Case ans
    Case vbYes
...
Private Sub cmdgenerate_Click()
 If Val(MSFlexGrid3.Rows) > 2 Then
...
validate_data
 ...
 If MSFlexGrid3.Rows > 1 Then
    If MSFlexGrid3.Text <> cbogasindex.Text Then
      If Len(MSFlexGrid3.Text) < 4 Then Else Check1(CInt(Right(MSFlexGrid3.Text, 1))).Enabled = True
    End If
 End If
 MSFlexGrid3.Text = cbogasindex.Text
...
While RS.EOF = False
     ...
     MSFlexGrid3.RowHeight(MSFlexGrid3.Row) = 200
Wend
If rowindentified > MSFlexGrid3.Rows - 1 Then
...
Private Sub update_gas_graph(index As Integer)
  '    lblEan(Index).Caption = Fix((100# - CDbl(Text2(Index).Text) - CDbl(txtoxygen(Index).Text)) * (CDbl(Text3(Index).Text) + conversion_factor) / 79 - conversion_factor)
...
cmdmodify.Visible = True
cmddepthup.Left = 960
cmddepthdown.Left = 1200
cmdtimeup.Left = 1800
cmdtimedown.Left = 2040
Label1.Left = 1440
lblminutes.Left = 2280
txtppo2v.Left = 720
txtppo2v.Width = 580
txtppo2v.Top = 2250
txtppo2v.FontSize = 10
txtppo2v.Height = 315
CMDPPO2PLUS.Left = 1320
CMDPPO2PLUS.Top = 2400
Command4.Left = 1560
Command4.Top = 2400
Label29.Left = 1320
Label29.Top = 2220
...
Else
  ...
  Else
    If vmix_vnumber = vmix_vnumberdl Then
    Else
      decoresultgridlite.Rows = decoresultgridlite.Rows + 1
      decoresultgridlite.Row = decoresultgridlite.Rows - 1
      decoresultgridlite.Col = 8
      decoresultgridlite.Text = Format(rate * feetormeter_factor, "###")
      decoresultgridlite.Text = " ----        " + decoresultgridlite.Text
    End If
  End If
End If
vmix_vnumberdl = vmix_vnumber
'decoresultgridlite.Rows = decoresultgridlite.Rows + 1
'decoresultgridlite.Row = decoresultgridlite.Rows - 1
'MSFlexGrid3.RowHeight = 100
...
tempgridlitesec = Right(decoresultgridlite.Text, 2) * 60

If Len(decoresultgridlite.Text) > 2 Then tempgridlitemins = Left(decoresultgridlite.Text, Len(decoresultgridlite.Text) - 2)
If Val(tempgridlitesec) + Val(tempdurationlitesec) > 59 Then
   templeftsec = (Val(tempgridlitesec) + Val(tempdurationlitesec)) - 60
   templeftsec = Format(CDbl(templeftsec), "00")
   tempgridlitemins = Val(tempgridlitemins) + 1
Else
   templeftsec = Format(CDbl(Val(tempgridlitesec) + Val(tempdurationlitesec)), "00")
End If
totalmins = Val(tempgridlitemins) + Val(tempdurationlitemins)
...
If KeyAscii = 13 Then
  If Val(txtdepthft) < 0 Or Val(txtdepthft) > 2000 Then
     MsgBox " Depth value out of range !"
  Else
'     If Option4.Value = True And Val(txtdepth) <> 0 Then
'        txtppo2v = CStr(((CDbl(txtdepth) / 10#) + 1) * (CDbl(lblo2.Caption) / 100))
...
If KeyAscii = 13 Then
  If Val(txttime) < 0 Or Val(txttime) > 3000 Then
