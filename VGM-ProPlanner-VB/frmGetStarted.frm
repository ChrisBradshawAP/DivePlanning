...
gstr(4) = "Items in yellow are the calculated decompression result."
  ...
  If tipnum = 0 Then
    Command1(0).Caption = "Not Agree"
    Command1(1).Caption = "I Agree"
  Else
