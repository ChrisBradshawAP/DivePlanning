...
Global lastsortplanid  As String
Global systemversion As String
Global decographversion As String
Global dbfilefound As Boolean
Global tempfileselected As String
Global destinationsource As String
Global Source As String
Global ans As Variant
Global doneupdateonce As Integer
Global tempdpid As String
Global tempdpid2 As String
Global tempdiveid As String
Global current_index As Integer
Global detectdouclick As Boolean
Global laststop_index As Integer
Global vhmx_maxd_factor As Double
Global vhmx_stop_factor As Double
Global vhmx_safe_factor As Double
Global vhmx_mid_factor As Double
...
Else
   While RS3.EOF = False
      If IsNull(RS3("dpprofileid")) Then
        tempdpid = "SP00000001"
        RS3.Edit
        RS3!Dpprofileid = tempdid
        RS3.Update
      Else
