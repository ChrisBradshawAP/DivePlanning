...
Begin VB.Form Planprofile 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin MSChart20Lib.MSChart MSChart3 
         Height          =   1815
         Left            =   120
         OleObjectBlob   =   "Planprofile.frx":78AE
         TabIndex        =   34
         Top             =   240
         Width           =   3960
      End
   ...
   Begin VB.Frame Frame3 
      ...
      Begin MSChart20Lib.MSChart MSChart1 
         Height          =   1815
         Left            =   120
         OleObjectBlob   =   "Planprofile.frx":91A8
         TabIndex        =   12
         Top             =   240
         Width           =   4215
      End
...
'=======================================================================
Dim vmix_change(10) As Integer
Dim vfraction_voxygen(10) As Double
Dim vdepth_change(10) As Double
Dim rate_change(10)  As Double
Dim vstep_size_change(10) As Double
...
Dim vfraction_vhelium(10)  As Double
Dim vfraction_vnitrogen(10) As Double
...
Dim Plan_Gas_list_used(100) As Double
...
Dim DataChanged, tempdepth, temptime, tempo2, temphe, tempgasindex, tempcircuit As String
Dim zoom As Integer
Dim pan As Integer
...
If Option3.Value = True Then
   MSFlexGrid3.Text = "Close Circuit"
Else
...
MSFlexGrid3.ColWidth(1) = 720
MSFlexGrid3.ColWidth(2) = 720
MSFlexGrid3.ColWidth(3) = 720
MSFlexGrid3.ColWidth(4) = 720
MSFlexGrid3.ColWidth(5) = 1360
MSFlexGrid3.ColWidth(6) = 1020
End Sub
...
cbogasindex.Text = lblgasindex(i).Caption
tempgasused = Cbogasused(i).Text
txtppo2v = txtppo2(i).Text
If InStr(tempgasused, "Close") Then
   Option3.Value = True
Else
   If InStr(tempgasused, "Open") Then
      Option4.Value = True
   Else
      Option3.Value = False
      Option4.Value = False
...
End If
  SQL = "SELECT * FROM dpmaingaslist "
  SQL = SQL & " where dpmainid = '" & tempserialno & "' and dpgasused = '" & tempgasused & "' "
  SQL = SQL & " order by dpgasused "
  Set RS = DB.OpenRecordset(SQL)
  RS.MoveFirst
  While RS.EOF = False
     tempgasindex = RS("dpgasid")
     cbogasindex.AddItem tempgasindex
     RS.MoveNext
  Wend
End If
End Sub
...
For p = 1 To 6
  ...
  Case 5
     If MSFlexGrid3.Text = "Close Circuit" Then
        Option3.Value = True
        Option4.Value = False
        txtppo2v.Enabled = False
     Else
...
If (valtitude_dive_valgorithm_off) Then
    ...
    t1print ("Alt")
    t1print (valtitude_of_dive)
    t1print ("Atmmospheric")
    t1print (barometric_vpressure)
    t1print (vbCrLf)
    For i = 1 To 16
...
Do While (True)                     'loop will run continuous
    ...
    Do While Planpoint <= Number_of_planpoints                     'loop will run continuous
        ...
        If Planpoint = 0 Or vprofile_code = 2 Then 'get next point and start with rate change
          vprofile_code = 1
          vmix_number = Plan_GasID(Planpoint)
          If (Planpoint = 0) Then
        ...
        If (vprofile_code = 1) Then
            ...
            t1print8 (vsegment_vnumber)
            t1print8 (vsegment_vtime)
            t1print8 (run_vtime)
            t1print8 (vmix_vnumber)
            t1print8 (vdepth)
            t1print8 (starting_vdepth)
            t1print8 (ending_vdepth)
            t1print8 (rate)
            t1print (vbCrLf)
...
L50:
    Do While (True)                     'loop will run continuous
        ...
        If (vdeco_vstop_vdepth = 0#) Then
            ...
            ending_vdepth = 0#
            Call gas_loadings_ascent_descent(starting_vdepth, ending_vdepth, rate)
            t1print ("  #     Dur     RT      Mix     Depth   Rate    ")
            t1print8 (vsegment_vnumber)
            t1print8 (vsegment_vtime)
            t1print8 (run_vtime)
            t1print8 (vmix_vnumber)
            t1print8 (vdeco_vstop_vdepth)
            t1print8 (rate)
            t1print (vbCrLf)
...
L70:
        If ((schedule_converged) Or (critical_volume_valgorithm_off)) Then
            ...
            '=======================================================================
            t1print (vbCrLf + "  " + "   #     Dur      RT     Mix   Depth    Rate   Stime" + vbCrLf)
            Do While (True)                      'loop will run continuous
                'there is an exit stateme
                Call gas_loadings_ascent_descent(starting_vdepth, vdeco_vstop_vdepth, rate)
                '=======================================================================
                ...
                If (CDbl(CInt(minimum_vdeco_vstop_vtime)) = minimum_vdeco_vstop_vtime) Then
                    t1print (vsegment_vnumber)
                    t1print (vsegment_vtime)
                    t1print (Left(CStr(run_vtime), 6))
                    t1print (vmix_vnumber)
                    t1print (CInt(vdeco_vstop_vdepth))
                    t1print (CInt(vstop_vtime))
                    t1print (CInt(run_vtime))
                    t1print (vbCrLf)
                Else
                    t1print8 (vsegment_vnumber)
                    t1print8dbl (CDbl(CInt(vsegment_vtime * 10# + 0.999) / 10))
...
'=======================================================================
Public Function schreiner_equation(initial_inspired_gas_vpressure, rate_change_insp_gas_vpressure, interval_vtime, gas_vtime_constant, initial_gas_vpressure) As Double
'=======================================================================
'     arguments
'=======================================================================
...
'=======================================================================
End Function
Function haldane_equation(initial_gas_vpressure, inspired_gas_vpressure, gas_vtime_constant, interval_vtime) As Double
'=======================================================================
'     arguments
'=======================================================================
' sub parameter : do not dim ! Dim initial_gas_vpressure as double
...
'=======================================================================
End Function
Sub gas_loadings_ascent_descent(starting_vdepth, ending_vdepth, rate)
'      implicit none
'=======================================================================
'     arguments
'=======================================================================
...
'=======================================================================
End Sub
Sub calc_crushing_vpressure(starting_vdepth, ending_vdepth, rate)
'      implicit none
'=======================================================================
'     arguments
'=======================================================================
...
'=======================================================================
Sub onset_of_impermeability(starting_ambient_vpressure, ending_ambient_vpressure, rate, i)
'      implicit none
'=======================================================================
'     arguments
'=======================================================================
' sub parameter : do not dim ! Dim i                         'input - array subscript for com as integer
...
'     cambridge university press, 1992.
'=======================================================================
Sub radius_root_finder(a, b, c, low_bound, high_bound, ending_radius)
'      implicit none
'=======================================================================
'     arguments
'=======================================================================
...
For i = 1 To 100
    If ((((ending_radius - radius_at_high_bound) * derivative_of_funcion - funcion) * ((ending_radius - radius_at_low_bound) * derivative_of_funcion - funcion) >= 0#) Or (Abs(2# * funcion) > (Abs(last_diff_change * derivative_of_funcion)))) Then
        ...
        If (radius_at_low_bound = ending_radius) Then Close #1: Exit Sub
        Else
        last_diff_change = differential_change
        ...
        If (last_ending_radius = ending_radius) Then Close #1: Exit Sub
    End If
    If (Abs(differential_change) < 0.000000000001) Then Close #1: Exit Sub
    funcion = ending_radius * (ending_radius * (a * ending_radius - b)) - c
    derivative_of_funcion = ending_radius * (ending_radius * 3# * a - 2# * b)
    If (funcion < 0#) Then
...
'=======================================================================
Sub gas_loadings_constant_vdepth(vdepth, run_vtime_end_of_vsegment)
'      implicit none
'=======================================================================
'     arguments
'=======================================================================
...
'=======================================================================
End Sub
Sub nuclear_regeneration(dive_vtime)
'      implicit none
'=======================================================================
'     arguments
'=======================================================================
...
'=======================================================================
End Sub
Sub calc_ascent_vceiling(ascent_vceiling_vdepth)
'      implicit none
'=======================================================================
'     arguments
'=======================================================================
...
'=======================================================================
End Sub
Sub calc_max_actual_gradient(vdeco_vstop_vdepth)
'      implicit none
'=======================================================================
'     arguments
'=======================================================================
...
'=======================================================================
End Sub
Sub critical_volume(vdeco_phase_volume_vtime)
'      implicit none
'=======================================================================
'     arguments
'=======================================================================
...
'     1992.
'=======================================================================
Sub calc_start_of_vdeco_zone(starting_vdepth, rate, vdepth_start_of_vdeco_zone)
'      implicit none
'=======================================================================
'     arguments
'=======================================================================
...
L200:
        ...
        Close #1
        End Sub
Sub projected_ascent(starting_vdepth, rate, vdeco_vstop_vdepth, vstep_size)
        '      implicit none
        '=======================================================================
        '     arguments
        '=======================================================================
...
Sub boyles_law_compensation(first_vstop_vdepth, vdeco_vstop_vdepth, vstep_size)
'      implicit none
'=======================================================================
'     arguments
'=======================================================================
...
'=======================================================================
Sub vdecompression_vstop(vdeco_vstop_vdepth, vstep_size)
'      implicit none
'=======================================================================
'     arguments
'=======================================================================
...
End Sub
    ...
    '=======================================================================
Sub calc_vdeco_vceiling(vdeco_vceiling_vdepth)
    '      implicit none
    '=======================================================================
    '     arguments
    '=======================================================================
    ...
    '=======================================================================
End Sub
Sub gas_loadings_surface_interval(surface_interval_vtime)
    '      implicit none
    '=======================================================================
    '     arguments
    '=======================================================================
    ...
    '=======================================================================
End Sub
Sub vpm_repetitive_valgorithm(surface_interval_vtime)
    '      implicit none
    '=======================================================================
    '     arguments
    '=======================================================================
    ...
    '=======================================================================
End Sub
Sub calc_barometric_vpressure(valtitude)
    '      implicit none
    '=======================================================================
    '     arguments
    '=======================================================================
...
Sub vpm_valtitude_dive_valgorithm()
    ...
    '       real gradient_vhe_bubble_formation, gradient_vn2_bubble_formation
    Dim new_critical_radius_he As Double
    Dim new_critical_radius_n2 As Double
    Dim ending_radius_he As Double
    Dim ending_radius_n2 As Double
...
Private Function Max(m1, m2) As Double
  If m1 > m2 Then Max = m1 Else Max = m2
  
End Function

Private Function Min(m1, m2) As Double
  If m1 < m2 Then Min = m1 Else Min = m2
  
End Function

Private Sub t1print(t1 As Variant)
  Text10.Text = Text10.Text + "  " + CStr(t1)
End Sub

Private Sub t1print8(t1 As Variant)
Dim s As String
...
Private Sub t1print8dbl(t1 As Variant)
Dim s As String
...
'     MSFlexGrid3.Col = 6
     Plan_GasID(i) = CInt(Right(CStr(RS("gasid")), 1))
     RS.MoveNext
     i = i + 1
   Wend
  i = i - 1
  ...
  For i = 0 To 9
     ...
     Plan_Gas_list_used(i + 1) = Left(CStr(RS("dpgasused")), 1)
     RS.MoveNext
  Next i
