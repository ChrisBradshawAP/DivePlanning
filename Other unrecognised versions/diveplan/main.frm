...
Begin VB.Form main 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Top             =   0
      Width           =   8295
      Begin VB.CommandButton cmdviewvr3 
         Caption         =   "View VR3 Dive"
         BeginProperty Font 
            Name            =   "Comic Sans MS"
            Size            =   9.75
            Charset         =   0
   ...
   Begin VB.Menu mnuimport 
      Caption         =   "&Import"
      Begin VB.Menu mnurebrether 
         Caption         =   "&Rebrether"
      End
      Begin VB.Menu mnuvr3 
         Caption         =   "VR3"
      End
      Begin VB.Menu mnuimpfile 
         Caption         =   "&Text File"
      End
   ...
   Begin VB.Menu mnufile 
      ...
      Begin VB.Menu mnuopen 
         Caption         =   "&Open"
      End
      Begin VB.Menu mnufilecurrent 
         Caption         =   "&Default"
         Begin VB.Menu mnucurrentmain 
            Caption         =   "&Main"
         End
         Begin VB.Menu mnucurrentprofile 
            Caption         =   "&Profile"
         End
         Begin VB.Menu mnucurrentgas 
            Caption         =   "&Gas"
         End
         Begin VB.Menu mnucurrentissue 
            Caption         =   "&Tissue"
         End
      End
   End
              ...
              ' PDBMoveNext (dbdivelist)
               ...
               If Diveprofile = True And v > 0 Then
                ...
                For K = 0 To i
                 ...
                 Case 1
                   If IsNumeric(Val(txt2(K))) = True And Len(txt2(K)) = 4 Then
                      tempcode = Val(txt2(K)) * 0.09375
                 ...
                 Case 5
                   ...
                   If IsNumeric(tempcoderight) = True And Len(txt2(K)) = 5 And tempcodeleft = "T" Then
                      tempcoderight = Val(tempcoderight)
