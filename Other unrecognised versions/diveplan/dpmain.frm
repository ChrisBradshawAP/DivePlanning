...
Begin VB.Form planmain 
   BackColor       =   &H80000013&
   Caption         =   "Dive Plan Main List"
   ClientHeight    =   8475
   ClientLeft      =   165
   ClientTop       =   855
   ClientWidth     =   11880
   Icon            =   "dpmain.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   8475
   ScaleWidth      =   11880
...
ans = MsgBox("You have Dive plan that did not save on last setting, " & Chr(13) & "Press No will remove all previous unsave plan !" & Chr(13) & "Do you want to save now ?", vbYesNo + vbCritical + vbDefaultButton2, "Comfirmation")
Select Case ans
Case vbYes
   savedpmain
   MsgBox "Dive plan Save !!"
Case vbNo
   deletedpmain
End Select
End If
...
Set RS = DB.OpenRecordset(SQL)
planmain.Caption = "Dive Plan List "
