...
For i = 0 To 9
  If Option1(i).Value = True Then
    Decochk(i).BackColor = vbBlue
    Label32(i).BackColor = vbBlue
  
    Label13(i).BackColor = vbBlue
    Check1(i).BackColor = vbBlue
    Check2(i).BackColor = vbBlue
    Label28(i).BackColor = vbBlue
    lblgasindex(i).BackColor = vbBlue '&H80FFFF
    txtoxygen(i).BackColor = vbBlue
    txthelium(i).BackColor = vbBlue
    txtmaxd(i).BackColor = vbBlue
    txtppo2(i).BackColor = vbBlue
    Cbogasused(i).BackColor = vbBlue
    txtmaxdft(i).BackColor = vbBlue
    lblgasindex(i).ForeColor = vbWhite '&H80FFFF
    txtoxygen(i).ForeColor = vbWhite
    txthelium(i).ForeColor = vbWhite
    txtmaxd(i).ForeColor = vbWhite
    txtppo2(i).ForeColor = vbWhite
    Cbogasused(i).ForeColor = vbWhite
    txtmaxdft(i).ForeColor = vbWhite
    'update_gas_graph (Index)
  End If
  If Decochk(i).Value = True Then
...
' MsgBox Cbogasused(Index).Text
  ...
  Decochk(Index).BackColor = vbRed
  Label32(Index).BackColor = vbRed
  
  Label13(Index).BackColor = vbRed
  Check1(Index).BackColor = vbRed
  Check2(Index).BackColor = vbRed
  Label28(Index).BackColor = vbRed
  lblgasindex(Index).BackColor = vbRed '&H80FFFF
  txtoxygen(Index).BackColor = vbRed
  txthelium(Index).BackColor = vbRed
  txtmaxd(Index).BackColor = vbRed
  txtppo2(Index).BackColor = vbRed
  Cbogasused(Index).BackColor = vbRed
  txtmaxdft(Index).BackColor = vbRed
