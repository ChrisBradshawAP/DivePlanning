...
'                        vstep_size = vstep_size_change(1) / 2
                ...
                If vhmx_first_stop = 0 Then
                  ...
                  gf_1 = (vhmx_ptissue - vdeco_vstop_vdepth) / (vhmx_tol_pressure_bnorm - vdeco_vstop_vdepth)
                End If
                '=======================================================================
                ...
                If vdeco_vstop_vdepth < 6 Then
                  If vhmx_last_stop = 0 Then
                    ...
                    gf_2 = (vhmx_ptissue - vdeco_vstop_vdepth) / (vhmx_tol_pressure_bnorm - vdeco_vstop_vdepth)
                    Label6.Caption = "EGF: " + Format(gf_1 * 100, "0") + "/" + Format(gf_2 * 100, "0")
                    Cls
                  End If
                End If
L80:
