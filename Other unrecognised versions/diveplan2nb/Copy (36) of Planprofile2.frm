...
For i = 1 To 16
    ...
    If (buhl_mode = 2) Then
            ...
            amultfactorcalc (i - 1)
            jpb_main (i - 1)
            ans_tot = ans_N2 * nfrac / (nfrac + hefrac) + ans_He * hefrac / (nfrac + hefrac)
...
'//for all compartments later in calculation
  ...
  p2_turnline_points00(9) = 30
  p2_turnline_points01(9) = 70
  p2_turnline_points10(9) = 120
  p2_turnline_points11(9) = 30
