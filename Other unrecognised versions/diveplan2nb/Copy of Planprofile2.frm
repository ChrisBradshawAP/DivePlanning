...
Begin VB.Form Planprofile2 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.Label Label5 
         ...
         Caption         =   " VGM Safety Bubble Control"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox Cbogasused 
         ...
         Height          =   315
         Index           =   2
         ItemData        =   "Planprofile2.frx":77B4
         Left            =   3975
         List            =   "Planprofile2.frx":77B6
         Style           =   2  'Dropdown List
         TabIndex        =   67
         Top             =   4170
         Width           =   2025
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton Command4 
         ...
         Height          =   195
         Left            =   2520
         Picture         =   "Planprofile2.frx":20A81
         Style           =   1  'Graphical
         TabIndex        =   274
      ...
      Begin VB.CommandButton CMDPPO2PLUS 
         ...
         Height          =   195
         Left            =   2280
         Picture         =   "Planprofile2.frx":20C2B
         Style           =   1  'Graphical
         TabIndex        =   273
      ...
      Begin VB.CommandButton cmdtimedown 
         ...
         Height          =   190
         Left            =   3480
         Picture         =   "Planprofile2.frx":20E25
         Style           =   1  'Graphical
         TabIndex        =   43
      ...
      Begin VB.CommandButton cmdtimeup 
         ...
         Height          =   190
         Left            =   3240
         Picture         =   "Planprofile2.frx":20FCF
         Style           =   1  'Graphical
         TabIndex        =   42
      ...
      Begin VB.CommandButton cmddepthdown 
         ...
         Height          =   195
         Left            =   1560
         Picture         =   "Planprofile2.frx":211C9
         Style           =   1  'Graphical
         TabIndex        =   41
         ToolTipText     =   "Decrease the depth point"
         Top             =   1200
      ...
      Begin VB.CommandButton cmddepthup 
         ...
         Height          =   190
         Left            =   1320
         Picture         =   "Planprofile2.frx":21373
         Style           =   1  'Graphical
         TabIndex        =   40
         ToolTipText     =   "Increase the depth point"
         Top             =   1200
      ...
      Begin VB.CommandButton cmdclearall 
         ...
         Height          =   325
         Left            =   3400
         MouseIcon       =   "Planprofile2.frx":2156D
         Style           =   1  'Graphical
         TabIndex        =   36
      ...
      Begin VB.CommandButton Cmdadd 
         ...
         Height          =   495
         Left            =   1620
         Picture         =   "Planprofile2.frx":21877
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.CommandButton cmdmodify 
         ...
         Height          =   495
         Left            =   1620
         Picture         =   "Planprofile2.frx":23059
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton cmdinsert 
         ...
         Height          =   495
         Left            =   1620
         Picture         =   "Planprofile2.frx":2483B
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.Label singlelevel 
         ...
         Height          =   375
         Left            =   4320
         MouseIcon       =   "Planprofile2.frx":2601D
      ...
      Begin VB.Label lbllevel 
         ...
         Height          =   480
         Left            =   3960
         MouseIcon       =   "Planprofile2.frx":26327
         MousePointer    =   99  'Custom
         TabIndex        =   159
      ...
      Begin VB.Image Image1 
         ...
         Height          =   4215
         Left            =   0
         Picture         =   "Planprofile2.frx":26631
         Stretch         =   -1  'True
         Top             =   0
         Width           =   5775
      End
...
amult(3) = 1.25  ', //3 fast
amult(4) = 1.1    ', //4 fast
amult(5) = 1.06  ', //5 medium //1.02,
amult(6) = 1.04  ', //6 medium //1.00, //0.98,
amult(7) = 1#    ', //7 medium //0.97, //0.95,
amult(8) = 0.98  ', //8 medium //0.96, //0.94,
amult(9) = 0.96  ', //9 medium //0.94,
amult(10) = 0.94  ', //10 medium //0.92,
amult(11) = 0.9   ', //11 slow //0.88,
amult(12) = 0.9   ', //12 slow //0.88,
amult(13) = 0.88  ', //13 slow
amult(14) = 0.88  ', //14 slow
amult(15) = 0.88 '  //15 slow

For j = 0 To 15
  amult(j) = amult(j) * 1.12
Next j
...
vhmx_safe_factor = 1# + 0.01 * CDbl(vhmx_text(3).Text)
  ...
  afact = afact + afact2
  If (afact > 1.1) Then afact = 1.1 'limit
