...
Begin VB.Form Planprofile2 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Label Label21 
         ...
         Left            =   2320
         TabIndex        =   262
         ToolTipText     =   "EEquivalent Air Narcosis Depth"
         Top             =   180
         Width           =   460
      End
      Begin VB.Label Label32 
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton cmdtimedown 
         ...
         Height          =   190
         Left            =   3480
         Picture         =   "Planprofile2.frx":1FF95
         Style           =   1  'Graphical
         TabIndex        =   43
      ...
      Begin VB.CommandButton cmdtimeup 
         ...
         Height          =   190
         Left            =   3240
         Picture         =   "Planprofile2.frx":2013F
         Style           =   1  'Graphical
         TabIndex        =   42
      ...
      Begin VB.CommandButton cmddepthdown 
         ...
         Height          =   195
         Left            =   1560
         Picture         =   "Planprofile2.frx":20339
         Style           =   1  'Graphical
         TabIndex        =   41
         ToolTipText     =   "Decrease the depth point"
         Top             =   1200
      ...
      Begin VB.CommandButton cmddepthup 
         ...
         Height          =   190
         Left            =   1320
         Picture         =   "Planprofile2.frx":204E3
         Style           =   1  'Graphical
         TabIndex        =   40
         ToolTipText     =   "Increase the depth point"
         Top             =   1200
      ...
      Begin VB.CommandButton cmdclearall 
         ...
         Height          =   325
         Left            =   3400
         MouseIcon       =   "Planprofile2.frx":206DD
         Style           =   1  'Graphical
         TabIndex        =   35
      ...
      Begin VB.CommandButton Cmdadd 
         ...
         Height          =   495
         Left            =   1620
         Picture         =   "Planprofile2.frx":209E7
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton cmdmodify 
         ...
         Height          =   495
         Left            =   1620
         Picture         =   "Planprofile2.frx":221C9
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton cmdinsert 
         ...
         Height          =   495
         Left            =   1620
         Picture         =   "Planprofile2.frx":239AB
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.Label singlelevel 
         ...
         Height          =   375
         Left            =   4320
         MouseIcon       =   "Planprofile2.frx":2518D
      ...
      Begin VB.Label lbllevel 
         ...
         Height          =   480
         Left            =   3960
         MouseIcon       =   "Planprofile2.frx":25497
         MousePointer    =   99  'Custom
         TabIndex        =   159
      ...
      Begin VB.Image Image1 
         ...
         Height          =   4215
         Left            =   0
         Picture         =   "Planprofile2.frx":257A1
         Stretch         =   -1  'True
         Top             =   0
         Width           =   5775
      End
...
If Left(Cbogasused(index).Text, 1) = "0" Or Left(Cbogasused(index).Text, 1) = "4" Or Left(Cbogasused(index).Text, 1) = "5" Then Exit Sub
