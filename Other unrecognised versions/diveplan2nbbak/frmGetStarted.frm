...
gtitle(1) = "Main Menu"
gtitle(2) = "Dive Planning - Single Level"
gtitle(3) = "Dive Planning - Multi Level"
...
gstr(2) = "This is the screen for planning a new single dive," + vbCrLf + vbCrLf + vbCrLf + "Picture 1 show the input screen for single level." + vbCrLf + vbCrLf + vbCrLf + "Each value of gas can be modify" + vbCrLf + "Press 'Generate' to generate the decompression result."
gstr(3) = "This is the screen for planning a new single dive," + vbCrLf + vbCrLf + vbCrLf + "Picture 1 show the input screen for the multi level." + vbCrLf + vbCrLf + "Picture 2 show the gas setting screen for the dive planning selection." + vbCrLf + vbCrLf + "For more details on how to plan a new dive, check on the walk through section."
...
gstr(6) = "This section of the dive series planner displays the of a dive within a series of dives. The profile graph of the dive and the textThe depth point with the decompression result." + vbCrLf + vbCrLf + vbCrLf + "Simply click on any point of the graph to obtain the data of the position. "
  ...
  If tipnum = 6 Then Command2.Visible = True Else Command2.Visible = False
