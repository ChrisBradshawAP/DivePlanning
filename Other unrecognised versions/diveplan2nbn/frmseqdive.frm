...
Begin VB.Form frmseqdive 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(1)=   "decoresultgrid(0)"
      Tab(0).Control(2)=   "lblminsg(0)"
      Tab(0).Control(3)=   "lblunitsg(0)"
      Tab(0).Control(4)=   "lblzerotimeg(0)"
      Tab(0).Control(5)=   "lbltimeg(0)"
      Tab(0).Control(6)=   "lbldepg(0)"
      Tab(0).Control(7)=   "lblzerodepg(0)"
      Tab(0).Control(8)=   "Label14(0)"
      ...
      Tab(1).Control(2)=   "lblminsg(1)"
      Tab(1).Control(3)=   "lblunitsg(1)"
      Tab(1).Control(4)=   "Label14(1)"
      Tab(1).Control(5)=   "lblzerodepg(1)"
      Tab(1).Control(6)=   "lbldepg(1)"
      Tab(1).Control(7)=   "lbltimeg(1)"
      Tab(1).Control(8)=   "lblzerotimeg(1)"
      ...
      Tab(2).Control(2)=   "lblminsg(2)"
      Tab(2).Control(3)=   "lblunitsg(2)"
      Tab(2).Control(4)=   "Label14(2)"
      Tab(2).Control(5)=   "lblzerodepg(2)"
      Tab(2).Control(6)=   "lbldepg(2)"
      Tab(2).Control(7)=   "lbltimeg(2)"
      Tab(2).Control(8)=   "lblzerotimeg(2)"
      Tab(2).ControlCount=   9
      TabCaption(3)   =   "Dive 4"
      TabPicture(3)   =   "frmseqdive.frx":9A12
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "Picture1(3)"
      Tab(3).Control(1)=   "decoresultgrid(3)"
      Tab(3).Control(2)=   "lblminsg(3)"
      Tab(3).Control(3)=   "lblunitsg(3)"
      Tab(3).Control(4)=   "Label14(3)"
      Tab(3).Control(5)=   "lblzerodepg(3)"
      Tab(3).Control(6)=   "lbldepg(3)"
      Tab(3).Control(7)=   "lbltimeg(3)"
      Tab(3).Control(8)=   "lblzerotimeg(3)"
      Tab(3).ControlCount=   9
      TabCaption(4)   =   "Dive 5"
      TabPicture(4)   =   "frmseqdive.frx":9A2E
      Tab(4).ControlEnabled=   0   'False
      Tab(4).Control(0)=   "Picture1(4)"
      Tab(4).Control(1)=   "decoresultgrid(4)"
      Tab(4).Control(2)=   "lblminsg(4)"
      Tab(4).Control(3)=   "lblunitsg(4)"
      Tab(4).Control(4)=   "Label14(4)"
      Tab(4).Control(5)=   "lblzerodepg(4)"
      Tab(4).Control(6)=   "lbldepg(4)"
      Tab(4).Control(7)=   "lbltimeg(4)"
      Tab(4).Control(8)=   "lblzerotimeg(4)"
      Tab(4).ControlCount=   9
      TabCaption(5)   =   "Dive 6"
      TabPicture(5)   =   "frmseqdive.frx":9A4A
      Tab(5).ControlEnabled=   0   'False
      Tab(5).Control(0)=   "Picture1(5)"
      Tab(5).Control(1)=   "decoresultgrid(5)"
      Tab(5).Control(2)=   "lblminsg(5)"
      Tab(5).Control(3)=   "lblunitsg(5)"
      Tab(5).Control(4)=   "Label14(5)"
      Tab(5).Control(5)=   "lblzerodepg(5)"
      Tab(5).Control(6)=   "lbldepg(5)"
      Tab(5).Control(7)=   "lbltimeg(5)"
      Tab(5).Control(8)=   "lblzerotimeg(5)"
      Tab(5).ControlCount=   9
      TabCaption(6)   =   "Dive 7"
      TabPicture(6)   =   "frmseqdive.frx":9A66
      Tab(6).ControlEnabled=   0   'False
      Tab(6).Control(0)=   "Picture1(6)"
      Tab(6).Control(1)=   "decoresultgrid(6)"
      Tab(6).Control(2)=   "lblminsg(6)"
      Tab(6).Control(3)=   "lblunitsg(6)"
      Tab(6).Control(4)=   "Label14(6)"
      Tab(6).Control(5)=   "lblzerodepg(6)"
      Tab(6).Control(6)=   "lbldepg(6)"
      Tab(6).Control(7)=   "lbltimeg(6)"
      Tab(6).Control(8)=   "lblzerotimeg(6)"
      Tab(6).ControlCount=   9
      TabCaption(7)   =   "Dive 8"
      TabPicture(7)   =   "frmseqdive.frx":9A82
      Tab(7).ControlEnabled=   0   'False
      Tab(7).Control(0)=   "Picture1(7)"
      Tab(7).Control(1)=   "decoresultgrid(7)"
      Tab(7).Control(2)=   "lblminsg(7)"
      Tab(7).Control(3)=   "lblunitsg(7)"
      Tab(7).Control(4)=   "Label14(7)"
      Tab(7).Control(5)=   "lblzerodepg(7)"
      Tab(7).Control(6)=   "lbldepg(7)"
      Tab(7).Control(7)=   "lbltimeg(7)"
      Tab(7).Control(8)=   "lblzerotimeg(7)"
      Tab(7).ControlCount=   9
      TabCaption(8)   =   "Dive 9"
      TabPicture(8)   =   "frmseqdive.frx":9A9E
      Tab(8).ControlEnabled=   0   'False
      Tab(8).Control(0)=   "Picture1(8)"
      Tab(8).Control(1)=   "decoresultgrid(8)"
      Tab(8).Control(2)=   "lblminsg(8)"
      Tab(8).Control(3)=   "lblunitsg(8)"
      Tab(8).Control(4)=   "Label14(8)"
      Tab(8).Control(5)=   "lblzerodepg(8)"
      Tab(8).Control(6)=   "lbldepg(8)"
      Tab(8).Control(7)=   "lbltimeg(8)"
      Tab(8).Control(8)=   "lblzerotimeg(8)"
      ...
      Tab(9).Control(7)=   "decoresultgrid(9)"
      Tab(9).Control(7).Enabled=   0   'False
      Tab(9).Control(8)=   "Picture1(9)"
...
'  End If
  ...
  While RS.EOF = False
     ...
     lbl02(i).Caption = 100 - Val(temphelium) - Val(tempnitrogen)
     lblhe(i).Caption = temphelium
     tempdepth = RS("dpgasmaxopdepth")
     tempdepth = Val(tempdepth) / 10
     lbldepth(i).Caption = Format(tempdepth, "###0")
     lblppo2(i).Caption = (Val(lbl02(i).Caption) / 100) * ((Val(lbldepth(i).Caption) / 10) + 1)
...
cleargrid1
If Trim(txtplanno.Text) <> "" And Val(txtinterval.Text) > 0 Then
   MSFlexGrid1.Rows = MSFlexGrid1.Rows + 1
   K = MSFlexGrid1.Rows
   MSFlexGrid1.Row = K - 1
   MSFlexGrid1.Col = 0
   ...
   loaddpprofiledata
  ' saveprorecord
  If Val(MSFlexGrid1.Rows) > 1 Then
...
tempdate = Format$(Date, "dd/mm/yyyy")
...
For i = 0 To 9
   ...
   tempnitrogen = 100 - Val(lblhe(i).Caption) - Val(lbl02(i).Caption)
   RS!dpgasnitrogen = tempnitrogen
   RS!dpgasmaxopdepth = Val(lbldepth(i).Caption) * 10
...
otu_current = 0
 ...
 For j = 1 To Number_Dives
  ...
  MSFlexGrid1.Col = 2
  surface_interval_vtime = MSFlexGrid1.Text
...
End If
'MSFlexGrid4.Text = CStr(vmix_vnumber - 1)
MSFlexGrid4.Col = 4
...
Else
    MSFlexGrid4.Text = "TX" + CStr(lbl02(vmix_vnumber - 1).Caption + "/" + lblhe(vmix_vnumber - 1).Caption)
End If
'MSFlexGrid4.Text = (vmix_vnumber - 1)
MSFlexGrid4.Col = 4
...
'  MsgBox maxd
  ...
  X(0) = 0
  Y(0) = 0
'  picture1(grid_num).Line (0, 0)-(x(1) * xscale, y(2) * yscale), vbBlue
'  picture1(grid_num).Line (x(1), y(2))-(x(2) * xscale, y(2) * yscale), vbBlue
'  picture1(grid_num).Line (0, 0)-(x(1) * xscale, y(2) * yscale), vbBlue
'  picture1(grid_num).Line (0, 0)-(x(1) * xscale, y(2) * yscale), vbBlue
'  picture1(grid_num).Line (0, 0)-(x(1) * xscale, y(2) * yscale), vbBlue
'  MsgBox xscale
'  MsgBox yscale
  For i = 1 To row_count
     Picture1(grid_num).Line (X(i - 1) * xscale, Y(i - 1) * yscale)-(X(i) * xscale, Y(i) * yscale), vbYellow
  Next i
...
'  msgres = MsgBox("Time: " & Format(timet, "###0mins") & vbCrLf & "Depth: " & Format(Y(i) * feetormeter_factor, "###0" & feetormeter_shortstring), vbOKOnly, "Dive Point")
  ...
  If i < 4 Then decoresultgrid(deco_grid_display).TopRow = 1 Else decoresultgrid(deco_grid_display).TopRow = i - 3
