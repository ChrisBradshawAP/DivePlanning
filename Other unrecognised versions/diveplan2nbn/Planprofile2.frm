...
End If
MSFlexGrid3.ColWidth(2) = 400
MSFlexGrid3.ColWidth(3) = 300
MSFlexGrid3.ColWidth(4) = 300
MSFlexGrid3.ColWidth(5) = 380
MSFlexGrid3.ColWidth(6) = 380
...
Private Sub txtdepthft_Change()
   ...
   txtdepthft_focus = 0
'
'  If Len(txtdepthft.Text) > 0 Then txtdepth.Text = Format(CStr(CDbl(txtdepthft.Text) / feetormeter_factor), "####.0")
End Sub
...
Private Sub txttime_Change()
  If MSFlexGrid3.Rows > 1 Then cmdmodify.Visible = True
  If Len(txttime.Text) > 3 Then txttime.Text = "999"
